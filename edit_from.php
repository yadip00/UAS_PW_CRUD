...
<body>
    <div class="container">
        <div class="col-md-12">
            <h3 style="margin: 20px 0px 20px 0px">Ubah Data Mahasiswa</h3>
            <form method="post" action="edit_aksi.php" class="form-horizontal">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Analis Bisnis" <?php if (in_array("Analis Bisnis", $checked)) echo "checked"; ?>>
                        <label class="form-check-label">
                        Analis Bisnis
                        </label>
                    </div>
                ...
                <div class="form-group mt-4">
                    <a href="index.php"  name="reset" class="btn btn-danger btn-space">Cancel</a>
